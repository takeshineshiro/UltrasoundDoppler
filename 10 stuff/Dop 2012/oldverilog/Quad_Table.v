...
/* Module Version: 1.3 */
/* C:\lscc\diamond\2.2_x64\ispfpga\bin\nt64\scuba.exe -w -n Quad_Table -lang verilog -synth synplify -bus_exp 7 -bb -arch mj5g00 -type cosine -addr_width 3 -width 8 -pfu -mode 2 -output_reg -e  */
/* Mon Jul 29 17:12:45 2013 */
...
module Quad_Table (Clock, ClkEn, Reset, Theta, Sine, Cosine)/* synthesis NGD_DRC_MASK=1 */;
    ...
    // synopsys translate_on
    ROM16X1 triglut_1_0_15 (.AD3(scuba_vlo), .AD2(Theta[2]), .AD1(Theta[1]), 
    ...
    // synopsys translate_on
    ROM16X1 triglut_1_0_14 (.AD3(scuba_vlo), .AD2(Theta[2]), .AD1(Theta[1]), 
    ...
    // synopsys translate_on
    ROM16X1 triglut_1_0_13 (.AD3(scuba_vlo), .AD2(Theta[2]), .AD1(Theta[1]), 
    ...
    // synopsys translate_on
    ROM16X1 triglut_1_0_12 (.AD3(scuba_vlo), .AD2(Theta[2]), .AD1(Theta[1]), 
    ...
    // synopsys translate_on
    ROM16X1 triglut_1_0_11 (.AD3(scuba_vlo), .AD2(Theta[2]), .AD1(Theta[1]), 
    ...
    // synopsys translate_on
    ROM16X1 triglut_1_0_10 (.AD3(scuba_vlo), .AD2(Theta[2]), .AD1(Theta[1]), 
    ...
    // synopsys translate_on
    ROM16X1 triglut_1_0_9 (.AD3(scuba_vlo), .AD2(Theta[2]), .AD1(Theta[1]), 
    ...
    // synopsys translate_on
    ROM16X1 triglut_1_0_8 (.AD3(scuba_vlo), .AD2(Theta[2]), .AD1(Theta[1]), 
    ...
    // synopsys translate_on
    ROM16X1 triglut_1_0_7 (.AD3(scuba_vlo), .AD2(Theta[2]), .AD1(Theta[1]), 
    ...
    // synopsys translate_on
    ROM16X1 triglut_1_0_6 (.AD3(scuba_vlo), .AD2(Theta[2]), .AD1(Theta[1]), 
    ...
    // synopsys translate_on
    ROM16X1 triglut_1_0_5 (.AD3(scuba_vlo), .AD2(Theta[2]), .AD1(Theta[1]), 
    ...
    // synopsys translate_on
    ROM16X1 triglut_1_0_4 (.AD3(scuba_vlo), .AD2(Theta[2]), .AD1(Theta[1]), 
    ...
    // synopsys translate_on
    ROM16X1 triglut_1_0_3 (.AD3(scuba_vlo), .AD2(Theta[2]), .AD1(Theta[1]), 
    ...
    // synopsys translate_on
    ROM16X1 triglut_1_0_2 (.AD3(scuba_vlo), .AD2(Theta[2]), .AD1(Theta[1]), 
    ...
    // synopsys translate_on
    ROM16X1 triglut_1_0_1 (.AD3(scuba_vlo), .AD2(Theta[2]), .AD1(Theta[1]), 
    ...
    // synopsys translate_on
    ROM16X1 triglut_1_0_0 (.AD3(scuba_vlo), .AD2(Theta[2]), .AD1(Theta[1]), 
